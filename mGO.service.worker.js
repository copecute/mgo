...
/** @type {string} */
const CACHE_VERSION = '1742727030|2131544112';
/** @type {string} */
const CACHE_PREFIX = 'mGO-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'mGO.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["mGO.html","mGO.js","mGO.offline.html","mGO.icon.png","mGO.apple-touch-icon.png","mGO.audio.worklet.js","mGO.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["mGO.wasm","mGO.pck","mGO.side.wasm"];
